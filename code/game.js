...
//messed with a some number. Just ended up making it go from left to right.
var maxStep = 0.05;

var wobbleSpeed = 1000000, wobbleDist = 1;
...
Purple.prototype.act = function(step){
	this.wobble += step * wobbleSpeed;
	var wobblePos = Math.sin(this.wobble) * wobbleDist;
